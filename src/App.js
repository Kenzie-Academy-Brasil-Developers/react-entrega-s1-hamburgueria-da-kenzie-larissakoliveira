...
const handleClick = (productId)=>{setCurrentSale([...currentSale, products.find((item)=>item.id === (productId))])}
  ...
  return (
    <div className="App">
      ...
      <h3 className='subtotal'>Subtotal: R${currentSale.reduce((anterior, atual)=>(anterior + atual.price),0)}</h3>
